...
export const metadata: Metadata = {
  title: "Keyrise Atlas | Travel & Mobility Research",
  description:
    "Keyrise Atlas publishes original research on visa policy, mobility trends and outbound travel, built on anonymised filing data.",
};
